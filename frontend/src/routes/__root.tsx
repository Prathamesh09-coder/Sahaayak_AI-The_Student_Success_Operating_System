...
function NotFoundComponent() {
  return (
    <div className="hero-bg flex min-h-dvh items-center justify-center px-4">
      <div className="glass shadow-soft max-w-md rounded-3xl p-10 text-center">
        <h1 className="gradient-text text-7xl font-bold">404</h1>
        <h2 className="mt-4 text-xl font-semibold">Page not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This page took a gap year. Let's get you back on track.
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    head: () => ({
      meta: [
        ...
        { title: "Sahaayak AI — Your Companion for Academic & Career Success" },
        {
          name: "description",
          content:
            "AI-powered Student Success Ecosystem for first-generation college students. Mentorship, scholarships, careers and opportunities — personalized.",
        },
        { name: "author", content: "Sahaayak AI" },
        {
          property: "og:title",
        ...
        },
        {
          ...
          content:
            "Personalized guidance, scholarships, mentorship, and opportunities for every first-generation learner.",
        },
